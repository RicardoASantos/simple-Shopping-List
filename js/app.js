...
$(document).ready(function(){
  ...
  function addItem() {
    ...
    $('.common').click(function(){
    	...
    	var object = $('p', this).text();
        	
        console.log(object);	
        	
        var text = "<li class='item'>" +
        				"<div class='checkbox'>" +
        					"<input class='inputCheck' type='checkbox' id='item-" + object + "'>" + 
        					"<label class='inputLabel' for='item-" + object + "'></label>" + 
       					"</div>" + 
        				"<input class='itemName' id='itemName-" + object + "' type='text' value='" +object+ "'>" + 
        				"</li>";   	
